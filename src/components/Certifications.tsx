            ...
            <div className="space-y-3">
              {certifications.map((cert, i) => (
                <motion.div
                  ...
                  className="flex items-center justify-between bg-[#0f172a] border border-white/5 rounded-xl px-5 py-4 hover:border-cyan-400/20 transition-colors group"
                >
                  ...
                  {cert.code && (
                    <span className="text-xs font-mono text-cyan-400 border border-cyan-400/30 bg-cyan-400/5 rounded-lg px-2.5 py-1 shrink-0">
                      {cert.code}
                    </span>
                  )}
                </motion.div>
            ...
            <div className="space-y-3">
              {education.map((edu, i) => (
                <motion.div
                  ...
                  className="bg-[#0f172a] border border-white/5 rounded-xl px-5 py-5 hover:border-violet-400/20 transition-colors group"
                >
