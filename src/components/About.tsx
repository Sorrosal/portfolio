...
const stats = [
  ...
  { value: "€80K", label: "Funding secured" },
];
          ...
          <div className="grid grid-cols-2 gap-4 w-full lg:w-auto lg:min-w-[320px]">
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="bg-[#0f172a] border border-white/5 rounded-2xl p-6 text-center hover:border-cyan-400/20 transition-colors"
              >
                <p className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-400 mb-1">
                  {stat.value}
                </p>
